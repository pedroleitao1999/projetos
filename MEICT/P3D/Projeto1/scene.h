...
public:
	...
	void setNumber(int id) { number = id; };
...
public:
	...
	Color GetBackgroundColor(void) { return bgColor; }
	Color GetSkyboxColor(Ray& r);
	bool GetSkyBoxFlg(void) { return SkyBoxFlg; }
	...
	vector<Object*> getAllObjects(void);
