...
import CreateClarificationRequestView from '@/views/student/CreateClarificationRequestView.vue';
import ClarifyStudentsQuestionView from '@/views/teacher/clarificationRequests/ClarifyStudentsQuestionView.vue';
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'create',
          name: 'create-clarifications',
          component: ClarifyStudentsQuestionView,
          meta: {
            title: process.env.VUE_APP_NAME + ' - Clarify Students Question',
            requiredAuth: 'Teacher'
          }
        },
      ]
    },
    {
      ...
      children: [
        ...
        {
          path: 'create',
          name: 'create-clarificationRequests',
          component: CreateClarificationRequestView,
          meta: {
            title: process.env.VUE_APP_NAME + ' - Create Clarification Requests',
            requiredAuth: 'Student'
          }
        },
        {
