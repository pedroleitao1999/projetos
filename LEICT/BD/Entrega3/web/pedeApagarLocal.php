<html>
  ...
  <?php
    ...
    echo("Apagar um local público");

    pg_close($connection);

  ?>

  <form action="apagaLocal.php">
    Latitude do local a apagar: <input type="text" name="latitude"><br>
    Longitude do local a apagar: <input type="text" name="longitude"><br>
