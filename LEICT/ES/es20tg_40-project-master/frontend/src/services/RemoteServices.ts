...
export default class RemoteServices {
  ...
  static generateStatementClarificationRequest(params: object): Promise<StatementClarificationRequest> {
    return httpClient
        .post(
            `/executions/${Store.getters.getClarificationRequest.clarificationRequestId}/clarificationRequests/generate`,
            params
        )
        .then(response => {
          return new StatementClarificationRequest(response.data);
        })
        .catch(async error => {
          throw Error(await this.errorMessage(error));
        });
  ...
  static generateStatementClarification(params: object): Promise<StatementClarification> {
    return httpClient
        .post(
            `/executions/${Store.getters.getClarification.clarificationId}/clarifications/generate`,
            params
        )
        .then(response => {
          return new StatementClarification(response.data);
        })
        .catch(async error => {
          throw Error(await this.errorMessage(error));
        });
