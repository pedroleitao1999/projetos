...
public enum ErrorMessage {
    ...
    QUESTION_HAS_NO_CLARIFICATION_REQUESTS("Question %d has no clarification requests associated"),
    ...
    REQUEST_IS_EMPTY("Your clarification request is empty"),
    REQUEST_SIZE_LIMIT_EXCEEDED("Your clarification request is too long"),
    CLARIFICATION_IS_EMPTY("Your clarification is empty"),
    CLARIFICATION_SIZE_LIMIT_EXCEEDED("Your clarification is too long"),
    CLARIFICATION_NOT_FOUND("Clarification not found with id %d"),
    DASHBOARD_NOT_FOUND("The Student Dashboard with id %d was not found");
