...
Matrix4x4::Matrix4x4() {
	ux = 1.0f; uy = 1.0f; uz = 1.0f; un = 1.0f;
	vx = 1.0f; vy = 1.0f; vz = 1.0f; vn = 1.0f;
	wx = 1.0f; wy = 1.0f; wz = 1.0f; wn = 1.0f;
	mx = 1.0f; my = 1.0f; mz = 1.0f; mn = 1.0f;
};
...
Matrix4x4 Matrix3x3::convertTo4x4() {
