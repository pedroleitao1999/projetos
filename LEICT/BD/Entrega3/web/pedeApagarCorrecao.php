<html>
  ...
  <?php
    ...
    echo("Apagar uma correção");

    pg_close($connection);

  ?>

  <form action="apagaCorrecao.php">
    Email da correção a apagar: <input type="text" name="email"><br>
    Nro da correção a apagar: <input type="text" name="nro"><br>
