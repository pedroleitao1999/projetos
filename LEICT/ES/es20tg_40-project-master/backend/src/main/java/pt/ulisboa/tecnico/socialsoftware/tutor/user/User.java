...
public class User implements UserDetails, Importable {
    ...
    public User(String name, String username, Integer key, User.Role role) {
        ...
        this.clarificationRequests = new ArrayList<ClarificationRequest>();
        this.clarifications = new ArrayList<Clarification>();
        this.studentDashboard = new StudentDashboard(this);
    }
